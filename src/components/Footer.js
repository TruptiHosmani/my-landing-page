    ...
    <footer className="p-4 bg-gray-50 sm:p-6 dark:bg-gray-800">
        <div className="mx-auto max-w-screen-xl">
                ...
                <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                    <div>
                        ...
                        <ul className="text-gray-600 dark:text-gray-400">
                            <li className="mb-4">
                                <a href="#contact" className="hover:underline">React</a>
                            </li>
                            <li>
                                <a href="#contact" className="hover:underline">Tailwind CSS</a>
                            </li>
                        </ul>
                    </div>
                    <div>
                        ...
                        <ul className="text-gray-600 dark:text-gray-400">
                            <li className="mb-4">
                                <a href="#contact" className="hover:underline ">Github</a>
                            </li>
                            <li>
                                <a href="#contact" className="hover:underline">Discord</a>
                            </li>
                        </ul>
                    </div>
                    <div>
            ...
            <div className="sm:flex sm:items-center sm:justify-between">
                <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a href="#contact" className="hover:underline">Your website</a>. All Rights Reserved.
                </span>
